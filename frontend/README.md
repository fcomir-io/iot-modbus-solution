...
1- Download template https://gumroad.com/d/6d0a8448901d87a08d8eab7a969aa2c6
2- npm install
3- npm audit fix
4- npm start
...
5- First customizations

5.1 - Change logo on Sidebar
5.2 - Define side bar menu modifiying '_nav.js'
5.3 - Create some views for the new sidebar options
  * Modify routes
  * Create views
5.4 - Adapt header
  * Eliminar User y Settings options
  * Eliminar TheHeaderDropdownTasks
  * Eliminar TheHeaderDropdownMssg


--------------
PENDING
- Definir logo y logo-negative
